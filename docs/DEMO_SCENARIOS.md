...
## 2. Mutually exclusive exact counts
...
This demonstrates a symmetric constraint grounded in shared event wording and a common resolution window.

## 3. Mutually exclusive nominees
